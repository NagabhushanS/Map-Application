...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int i=0; i<V; i++){
			degreeList.add(this.getInNeighbors(i).size()+this.getNeighbors(i).size());
		}
		
		// to sort it in descending order I will make use of comparator
		Collections.sort(degreeList, new Comparator<Integer>(){

			@Override
			public int compare(Integer o1, Integer o2) {
				return o2-o1; // o2-o1 to sort in descending order
			}
	...
	public static void main (String[] args) {
		...
		GraphLoader.loadRoadMap("data/airports/routesUA.dat", airportGraph);
